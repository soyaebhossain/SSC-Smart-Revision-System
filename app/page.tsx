...
export default function Home() {
  ...
  const nav=[{id:"overview",label:"Overview",icon:LayoutDashboard},{id:"students",label:"Students",icon:Users},{id:"gaps",label:"Learning Gaps",icon:Target},{id:"plans",label:"Revision Plans",icon:BrainCircuit},{id:"tests",label:"Weekly Progress",icon:Activity}];
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${mobile?"open":""}`}>
      ...
      <div className="side-note"><Sparkles size={18}/><div><b>Revision planner</b><p>8-week adaptive revision logic is ready.</p></div></div>
